...
const COLORS = ['#FA2C37', '#FF6900', '#875CF5', '#4f46e5', '#0ea5e9', '#10b981', '#f59e0b', '#ef4444']
        ...
        <div className='card mt-4 !p-4'>
          <div className='flex flex-wrap items-end gap-4'>
            <div className='flex-1 min-w-[200px]'>
              <label className='text-xs font-medium text-gray-500 mb-1 block'>Search by Category</label>
            ...
            <div className='max-h-[600px] overflow-y-auto pr-2 custom-scrollbar'>
              {filteredExpense.length === 0 && !loading ? (
                <div className='flex flex-col items-center justify-center py-12 text-gray-400'>
                  <LuHandCoins className='text-4xl mb-3'/>
